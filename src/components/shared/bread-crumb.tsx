import { RiHome6Line, type RemixiconComponentType } from "@remixicon/react";
...
const BreadcrumbItemComponent = ({ item, isLast, className, activeClassName }: BreadcrumbItemProps) => {
  ...
  return (
    <Link
      href={item.href}
      className={cn("text-sm font-medium text-gray-400 transition-colors hover:text-gray-600", className)}
    >
      {content}
    </Link>
  );
